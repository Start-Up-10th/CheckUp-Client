...
필수 두 항목을 모두 선택해야 계속할 수 있다. 전체 동의는 두 항목을 선택한다.
어떤 항목이든 해제하면 전체 동의도 해제한다. 선택 항목 `기숙사 공지 알림 수신`은 공지 기능 제거(2026-09-26)로 두지 않는다.
...
근거: SRC-USER-UI의 `개인정보 동의`, SRC-CONSENT-IMAGE, SRC-INTERVIEW. 공지 수신 항목 삭제는 SRC-NO-NOTICE.
