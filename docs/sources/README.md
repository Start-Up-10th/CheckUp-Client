...
| SRC-NO-NOTICE | 2026-09-26 대화: 학생 공지 목록·관리자 공지 작성이 기능명세서(student-ui/admin-ui)·Figma에 없고 인터뷰 한 줄(SRC-COMMUNITY)에서만 나온 것을 확인. 사용자가 팀원 의견으로 "우리는 그냥 공지 기능이 없는듯"이라고 결정하고, 뒤이은 질문에서 동의 화면 `기숙사 공지 알림 수신`과 `기숙사 공지사항 등록` 알림도 "둘 다 빼기"로 선택 | REQ-SCOPE-003, REQ-COM-005, REQ-AUTH-004, REQ-UI-004/005 |
...
| 공지 CRUD·학생 공지 목록(구 REQ-COM-004), `기숙사 공지사항 등록` 알림, 동의의 `기숙사 공지 알림 수신`(선택) | 공지 기능 전체 제외(REQ-SCOPE-003). 알림은 출석 완료·봉사 등록 2종, 동의는 필수 2개(SRC-NO-NOTICE, 2026-09-26). Figma 02·개인정보 동의와 08·알림 예시의 공지 항목은 따르지 않음 |
