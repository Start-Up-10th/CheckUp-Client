/** REQ-COM-005가 남기는 알림 유형 2개. 얼굴 재등록 요청·QR 만료 임박·공지 등록은 삭제됐다. */
export type NotificationType = "attendance" | "volunteer";
 ...
 * Figma 예시 5개 중 삭제된 유형 3개("얼굴 인식 재등록이 필요해요", "QR 코드 유효 시간이 곧
 * 만료돼요", "기숙사 공지사항이 등록되었습니다" — 공지 기능 제거 2026-09-26)는 빼고 남는 2개
 * 유형만 쓴다. 시각은 명세 예시 문구를 그대로 쓴다.
