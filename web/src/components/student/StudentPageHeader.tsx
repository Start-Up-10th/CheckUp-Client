  ...
  return (
    <header className="flex items-center gap-2.5 px-[18px] pb-4 pt-[58px] md:p-0">
      <Link
        href={backHref}
        aria-label="뒤로 가기"
        className="-m-2 p-2 text-[22px] leading-normal text-admin-text md:hidden"
      >
        ‹
      </Link>
      <h1 className="text-lg font-bold leading-normal text-admin-text md:text-2xl md:tracking-[-0.48px]">
        {title}
      </h1>
    </header>
  );
